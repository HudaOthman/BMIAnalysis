...
public class FoodList extends RecyclerView.Adapter<FoodList.ViewHolder> {
    ...
    public FoodList(Context context, List<Foods> results) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.food_item,
                parent, false));
    }
