                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            listFoodsAdapter = new FoodList(getApplicationContext(), foods);
                            recyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                            recyclerView.setAdapter(listFoodsAdapter);
                            listFoodsAdapter.OnItemCliclkLisener(new FoodList.ClickListener() {
                                @Override
                                public void onClick(Foods result) {
                                    Intent i = new Intent(getApplicationContext(), AddFood.EditFood.class);
